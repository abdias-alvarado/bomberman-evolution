...
class NivelTres(NivelBase):
    ...
    def __init__(self, jugador):
        ...
        self.fondo = self.utility.CargarImagen('fondoNivel3.jpg')
        self.nivel = 3
        ...
        self.listaEnemigos.add(Enemigo(300, 500, 1))
        self.listaEnemigos.add(Enemigo(500, 170, 4))
        self.listaEnemigos.add(Enemigo(600, 500, 3))
        self.listaEnemigos.add(Enemigo(250, 100, 4))
        self.listaEnemigos.add(Enemigo(120, 300, 6))
    ...
    def MusicaNivel(self):
        self.utility.ReproducirMusica('musicaNivel3.mp3')
